...
namespace Orchard.Comments {
    public class Migrations : DataMigrationImpl {
        ...
        public int Create() {
            ...
            SchemaBuilder.CreateTable(typeof(RecentCommentsPartRecord).Name, table => table.ContentPartRecord()
                .Column<int>("ContainerID")
                .Column<int>("Count")
            );

            ContentDefinitionManager.AlterPartDefinition(typeof(RecentCommentsPart).Name, builder =>
               builder.WithDescription("Renders a list of recent comments.")
          );

            ContentDefinitionManager.AlterTypeDefinition("RecentComments", builder =>
                builder.WithPart(typeof(RecentCommentsPart).Name)
                .WithSetting("Stereotype", "Widget").WithPart(typeof(WidgetPart).Name).WithIdentity().WithPart(typeof(CommonPart).Name)
            );
